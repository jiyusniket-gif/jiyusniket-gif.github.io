    ...
    <div class="page wrap">
      ...
      <section class="section feature reverse feature-link" data-nav-post="50-1">
        ...
        <div class="feature-copy reveal">
          ...
          <p class="muted feature-sub">그저 아르바이트로 시작한 현장에서 업무 자동화 프로그램을 개발했습니다.</p>
        </div>
      </section>
      ...
      <section class="section feature reverse feature-link" data-nav-post="50-2">
        ...
        <div class="feature-copy reveal">
          ...
          <p class="muted feature-sub">수기작성에 가까운 업무 배정 프로세스를 재정의하고, Google Apps Script 웹앱으로 직접 설계·구현했습니다.</p>
        </div>
      </section>
      ...
      <section class="section feature reverse feature-link" data-nav-post="50-3">
        ...
        <div class="feature-copy reveal">
          ...
          <p class="muted feature-sub">테스트 배포에서 사용자 반응을 분석하여 UI와 안내 방식을 전면 수정했습니다.</p>
        </div>
      </section>

      <section class="section reveal quote-block" data-nav-post="51">
        <blockquote class="display quote-text">언어는 트레이닝할 수 있지만,<br>문화를 읽는 감각은 시간이 만든다</blockquote>
        </br>
        <p class="muted">구조화 습관은 일하는 방식만이 아니라 소통 방식에도 적용됩니다. JLPT N1, 원어민에게 3.5년간 배운 일본어로 문화의 구조까지 읽어냅니다.<span class="nav-arrow">↗</span></p>
      </section>

      <section class="section reveal quote-block" data-nav="timeline">
        <p class="eyebrow">BACKGROUND</p>
        <blockquote class="display quote-text">제약, 건설, 호스피탈리티 — 다른 업종, 같은 패턴</blockquote>
        </br>
        <p class="muted">제약 콜센터의 오퍼레이션, 발주처 및 관계자와 계속해서 소통해야 하는 건설 시공 관리, 직접 CS를 봐야 했던 호텔과 내부고객 CS를 처리하는 호텔 발렛 운영까지 서로 완전히 다른 업종이었습니다. 하지만 저는 매번 같은 순서로 일했습니다 — 현장에서 문제를 발견하고, 구조화하고, 반복되는 일을 시스템으로 바꿔온 이력입니다. 어떤 전문가와도 그들의 언어로 대화하고 그 안의 구조를 함께 찾아낼 수 있습니다. 일본어 능력까지 더해, 언어의 경계 없이 협업합니다. 제가 걸어온 길을 소개합니다.<span class="nav-arrow">↗</span></p>
      </section>

      <section class="section reveal quote-block">
        <p class="eyebrow">CHANNEL TALK</p>
        <blockquote class="display quote-text">이 습관을, 채널톡에도 적용해봤습니다</blockquote>
        </br>
        <p class="muted">지원 준비를 하며 채널톡의 Alf 도입 경로를 살펴봤습니다. 셀프서비스와 전문가 컨설팅(50~300만원대) 사이, 비어있는 자리가 보였습니다. 공개된 정보만으로 관찰한 가설이지만, 그 갭과 제안을 1페이지로 정리했습니다.</p>
      </section>
